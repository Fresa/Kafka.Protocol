    ...
    public class ConsumerGroupHeartbeatResponse : Message
    {
        public ConsumerGroupHeartbeatResponse(Int16 version)
        {
            if (version.InRange(MinVersion, MaxVersion) == false)
                throw new UnsupportedVersionException($"ConsumerGroupHeartbeatResponse does not support version {version}. Valid versions are: 0-1");
            Version = version;
        ...
        /// <summary>
        /// <para>The member id is generated by the consumer starting from version 1, while in version 0, it can be provided by users or generated by the group coordinator.</para>
        /// <para>Versions: 0+</para>
        /// <para>Default: null</para>
        /// </summary>
