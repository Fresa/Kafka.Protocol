    ...
    public class ShareGroupHeartbeatResponse : Message
    {
        public ShareGroupHeartbeatResponse(Int16 version)
        {
            if (version.InRange(MinVersion, MaxVersion) == false)
                throw new UnsupportedVersionException($"ShareGroupHeartbeatResponse does not support version {version}. Valid versions are: 1");
            Version = version;
        ...
        /// <summary>
        /// <para>The member ID is generated by the consumer and provided by the consumer for all requests.</para>
        /// <para>Versions: 0+</para>
        /// <para>Default: null</para>
        /// </summary>
